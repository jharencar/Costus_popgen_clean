# =============================================================================
# genome-wide_d_f_dsuite_w_QTL_plots.R
# Along-genome d_f (Dsuite w50s25) with 500 kb averages and QTL CIs — mirrors
# the Dxy multi-panel figure (Dxy_10kb_LASIout_separate_chrs_w.500kb.avg_7QTL_narrowed.CIs)
# but uses Dsuite local d_f instead of pixy Dxy. (Column name in Dsuite output is "d_f".)
# =============================================================================
...
d_f_LASI_sep_chrs_w.QTL <- final_plots$Chrom1 + final_plots$Chrom2 + final_plots$Chrom3 +
...
ggsave(
  file.path(project_root, "Dsuite", "d_f_w50s25_LASIout_separate_chrs_w.500kb.avg_7QTL_narrowed.CIs.png"),
  d_f_LASI_sep_chrs_w.QTL,
  device = "png",
  width = 50,
  height = 20,
  units = "cm"
